...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "9c7dbe59-18d3-4e3b-8172-b44e57df0712",
...
const _lazy_6ma2M3 = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_6ma2M3, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_6ma2M3, lazy: true, middleware: false, method: undefined }
];
