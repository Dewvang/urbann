...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CKmd5YpK.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-D1KY43qT.mjs')
  },
  {
    name: "blog-id",
    path: "/blog/:id()",
    component: () => import('./_id_-Bfx8VU6A.mjs')
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import('./index-CgF6XUXr.mjs')
  },
  {
    name: "portfolio-id",
    path: "/portfolio/:id()",
    component: () => import('./_id_-H2-lNezk.mjs')
  },
  {
    name: "portfolio",
    path: "/portfolio",
    component: () => import('./index-Zhc729Gn.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CWrsrNFy.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C9chnat1.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-j5rBpf6Q.mjs'));
...
export { _export_sfc as _, __nuxt_component_1 as a, useRouter as b, useNuxtApp as c, useRuntimeConfig as d, entry$1 as default, nuxtLinkDefaults as e, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRoute as u };
